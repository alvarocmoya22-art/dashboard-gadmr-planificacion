...
export function repairMojibake(value: unknown) {
  ...
  return text
    ...
    .replace(/Reasignaci(?:[\uFFFD?]+|Ò³|Ã³)n/gi, 'Reasignación')
    ...
    .replace(/APROBACI[\uFFFD?]+N/gi, 'APROBACIÓN')
    .replace(/EXPROPIACI[\uFFFD?]+N/gi, 'EXPROPIACIÓN')
    ...
    .replace(new RegExp(`EXPROPIACI${brokenMark}N`, 'gi'), (match) => preserveUpper(match, 'EXPROPIACIÓN', 'Expropiación'))
    ...
    .replace(new RegExp(`PAZMI${brokenMark}O`, 'gi'), (match) => preserveUpper(match, 'PAZMIÑO', 'Pazmiño'))
    .replace(new RegExp(`PAZMIN${brokenMark}`, 'gi'), (match) => preserveUpper(match, 'PAZMIÑO', 'Pazmiño'))
    .replace(new RegExp(`APROBACI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'APROBACIÓN', 'Aprobación'))
    .replace(new RegExp(`FEDERACI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'FEDERACIÓN', 'Federación'))
    .replace(new RegExp(`PROHIBICI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'PROHIBICIÓN', 'Prohibición'))
    .replace(new RegExp(`RESOLUCI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'RESOLUCIÓN', 'Resolución'))
    .replace(new RegExp(`INTERVENCI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'INTERVENCIÓN', 'Intervención'))
    .replace(new RegExp(`ATENCI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'ATENCIÓN', 'Atención'))
    .replace(new RegExp(`ACCI${brokenAccentLoose}N`, 'gi'), (match) => preserveUpper(match, 'ACCIÓN', 'Acción'))
    .replace(new RegExp(`PR${brokenAccentLoose}XIM`, 'gi'), (match) => preserveUpper(match, 'PRÓXIM', 'Próxim'))
    .replace(new RegExp(`D${brokenAccentLoose}AS`, 'gi'), (match) => preserveUpper(match, 'DÍAS', 'días'))
    .replace(new RegExp(`L${brokenAccentLoose}PEZ`, 'gi'), (match) => preserveUpper(match, 'LÓPEZ', 'López'))
    .replace(new RegExp(`GUA${brokenAccentLoose}O`, 'gi'), (match) => preserveUpper(match, 'GUAÑO', 'Guaño'))
    .replace(new RegExp(`TREVIN${brokenAccentLoose}O`, 'gi'), (match) => preserveUpper(match, 'TREVIÑO', 'Treviño'))
